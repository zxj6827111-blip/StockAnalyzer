...
_DEFAULT_VALUES: dict[str, str | bool | float] = {
    ...
    "moneyflow_net_amount": float("nan"),
    "hk_hold_ratio": float("nan"),
    "hk_hold_change": float("nan"),
    "inst_net_amount": float("nan"),
    "block_trade_amount": float("nan"),
    "block_trade_volume": float("nan"),
    "block_trade_premium_discount": float("nan"),
