...
| 状态 | 条数 | 条目 |
|---|---|---|
| ✅ 已实现+测试 | 26 | #1 #2 #4 #5 #8 #9 #10 #12 #13 #14 #15 #16 #18 #19 #20 #21 #22 #23 #24 #25 #27 #28 #29 #30 #31 #32 |
| ⚠️ 部分/待补 | 1 | #26 |
| ❌ 疑似缺失 | 0 | — |
...
| 31 | 长假前 3 天自动降仓 50% | ✅ | week6/engines.py CalendarFactorEngine（长假=连续≥3 非交易日，前 1/2/3 个交易日 → 0.5，2026 日历数据核验） | test_week6_calendar_factor.py 8 参数化用例（春节/国庆/清明/五一/中秋） | 日历表仅覆盖 2026，2027+ 公布后需扩展（引擎无需改） |
...
### B. 待决策
- ~~#31 长假降仓语义~~ ✅ 已改为长假日历感知（2026-08-10）
